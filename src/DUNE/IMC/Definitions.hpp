...
namespace DUNE
{
  namespace IMC
  {
    ...
    //! New class ObstacleState for transmitting the position and velocity
    //! of an obstacle for collision avoidance controller.
    ...
    public:
      ...
      //! Since we model the obstacle in the horizontal plane, we may consider
      //! removing the unmodeled states. Keeping for now.

      static uint16_t
      getIdStatic(void)
      {
        return 359; //! Choosing an unused id
      }
